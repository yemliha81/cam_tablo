        ...
        <div class="main-header">
            <div class="row">
                ...
                <div class="col-lg-7 col-sm-8 col-md-6 col-xs-5 col-ts-12" style="text-align:center;">
                    <a href="#">
                        <img src="assets/cam-demo-images/koku-life-pdf.svg" alt="img" width="280">
                    </a>
                </div>
                ...
                <div class="header-nav">
                    <div class="container-wapper" style="display: flex;align-items: center;justify-content: flex-end;">
                        <ul class="stelina-clone-mobile-menu stelina-nav main-menu " id="menu-main-menu">
                            <li class="menu-item">
                                <a href="#" class="stelina-menu-item-title" title="Home">Anasayfa</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="stelina-menu-item-title" title="Shop">Ürünler</a>
                            </li>
                            <li class="menu-item">
                                <a href="#" class="stelina-menu-item-title" title="About">Hakkımızda</a>
                            </li>
                            <li class="menu-item">
...
<div class="header-device-mobile">
    <div class="wapper">
        <div class="item mobile-logo">
            <div class="logo">
                <a href="#">
                    <img src="assets/cam-demo-images/koku-life-pdf.svg" alt="img" width="240">
                </a>
            </div>
        </div>
